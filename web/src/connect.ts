...
import { DailyChecklistService } from "./types/proto/api/v1/daily_checklist_service_pb";
...
export const dailyChecklistServiceClient = createClient(DailyChecklistService, transport);
